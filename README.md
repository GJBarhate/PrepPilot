...
These were produced by running `scripts/simulate_candidate.py`, which feeds the same orchestrator with a simulated candidate persona instead of manual CLI input. Each transcript notes this upfront.
